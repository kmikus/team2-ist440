...
public class SoundManager : MonoBehaviour
{
    ...
    public AudioSource laserBeamSource;            //To avoid sound collisions
    ...
    void Awake()
    {
        ...
        //Set GameObject to DontDestroyOnLoad so that it won't be destroyed when reloading our scene.
    ...
    public void PlayerLaser(AudioClip clip) {
        laserBeamSource.clip = clip;
